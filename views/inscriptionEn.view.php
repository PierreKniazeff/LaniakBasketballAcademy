...
<head>
    ...
    <link href="public/css/.css" rel="stylesheet"><!-- Replace with your file name if needed -->
...
<div class="container">
    ...
    <p style="font-style: italic; font-weight: bold; margin-bottom: 15px;">
        <strong>
            The data you provide will only be used to personalize training programs and improve your experience with our service,
            in accordance with Article 6 of the GDPR (see
            <a href="index.php?page=MentionsLegalesEn">legal notice here</a>).
        </strong>
    </p>
