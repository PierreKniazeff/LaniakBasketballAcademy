    ...
    <div class="container-sm">
        <div class="row">
            <div class="col-lg-6">
                ...
                <br><br><img src="./public/assets/images/NosValeurs1.PNG" class="img-fluid"
                ...
                <p class="roboto-font text-justify" style="max-width: 100%;"><br>
                    ...
                    Pour se faire, on y apprend à se challenger, à conquérir un esprit ouvert et combatif.<br><br>
                    Laniak ACADEMY vous donnes la possibilité d’exprimer votre potentiel de manière
                    individuelle et collective afin de progresser.
                </p>
            </div>
            <div class="col-lg-6">
                <!-- Image à droite du titre -->
                <img src="./public/assets/images/Carou26.jpg" class="img-fluid" style="max-width: 100%;">
            </div>
        </div>
