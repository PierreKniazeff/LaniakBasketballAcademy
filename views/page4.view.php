...
<!-- Carrousel de vidéos Bootstrap -->
<div>
<h1 class="roboto-font mt-5 mb-3">Galerie Vidéos</h1><br>
<div id="carouselExampleDarkVideos" class="carousel carousel-dark slide">
    <div class="carousel-inner">
        <!-- Remplacez les liens vers les vidéos par les liens de vos propres vidéos -->
...
<div>
<!-- Carrousel de photos Bootstrap -->
<br><br><br><h1 class="roboto-font">Galerie Photos</h1><br>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        carouselVideos.addEventListener('slide.bs.carousel', function (event) {
            ...
            videos.forEach(function (video) {
                video.pause(); // Arrête toutes les vidéos en cours de lecture
            });
        });
    });
</script>
