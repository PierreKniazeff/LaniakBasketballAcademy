<?php
$page_title = 'utilisateurEn'; // Définition de la variable pour menu.php
...
if (!isset($_SESSION['user_logged_in']) || !$_SESSION['user_logged_in']) {
    echo "<script>window.location.href = '" . URL . "views/connexionEn.view.php';</script>"; // Rediriger vers la page de connexion
    exit;
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['saveButton'])) {
    ...
    $objectifs = $_POST['objectifs'] ?? '';
       ...
       if ($result) {
           ...
           // Enregistrer à nouveau l'objet utilisateur mis à jour dans la session
